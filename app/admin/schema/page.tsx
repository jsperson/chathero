      ...
      {showClearConfirm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-md mx-4">
            <h3 className="text-xl font-bold mb-4">Clear Schema Configuration?</h3>
            <p className="mb-6 text-gray-600">
              This will delete schema configuration files (<code className="bg-gray-100 px-2 py-1 rounded">metadata.yaml</code>, <code className="bg-gray-100 px-2 py-1 rounded">schema.yaml</code>) and reset to auto-discovered schema.
              This will not affect README or query examples.
